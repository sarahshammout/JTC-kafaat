...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Available for Donation" value={available}                      emoji="🖥️" color="text-blue-500" />
        ...
        <StatCard label="Total Repair Cost"       value={`${totalCost.toFixed(2)} JOD`} emoji="$"  color="text-red-500" />
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 px-5 py-4 border-b border-slate-100">
          ...
          <span className="font-semibold text-slate-700">Total Laptops: {filtered.length}</span>
        </div>
